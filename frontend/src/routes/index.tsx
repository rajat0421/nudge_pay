...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Dashboard — Remindly invoice follow-up" },
      {
        name: "description",
        content:
          "See outstanding, overdue and collected invoice totals at a glance, plus every reminder Remindly sent on your behalf.",
      },
      { property: "og:title", content: "Dashboard — Remindly invoice follow-up" },
      {
